...
export default function App() {
 ...
 case"neo-mint":
 return darkMode
 ?"bg-slate-900 text-emerald-50"
 :"bg-slate-50 text-slate-900";
 case"neo-sunset":
 return darkMode
 ?"bg-slate-900 text-purple-50"
 :"bg-slate-50 text-slate-900";
 case"neo-classic":
 default:
 return darkMode
 ...
 >
 {/* 0. FLOATING BACKDROP CANVAS & GRID (Removed for clean aesthetic) */}
 ...
 className="p-3 bg-slate-900 text-white rounded-full border border-slate-700 shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all cursor-pointer flex items-center justify-center"
 ...
 target="_blank"
 rel="noreferrer"
 className="p-4 bg-emerald-600 hover:bg-emerald-500 text-white rounded-full border border-emerald-500 shadow-md hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center justify-center"
 ...
 <div className="relative transform overflow-hidden rounded bg-white text-left shadow-xl transition-all sm:my-8 w-full max-w-lg border border-slate-200 p-6 sm:p-8">
 {quoteSubmitted && (
 <div className="absolute inset-0 bg-white/95 z-30 flex flex-col items-center justify-center text-center p-6">
 <div className="w-16 h-16 bg-blue-50 text-blue-500 rounded-full flex items-center justify-center text-2xl font-bold mb-4">
 ✓
 </div>
 ...
 className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 focus:outline-none font-bold"
 />
 </div>
 ...
 onChange={handleQuoteFormChange}
 className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 focus:outline-none font-bold cursor-pointer"
 >
 ...
 <button
 type="submit"
 className="w-full py-3 bg-pink-600 hover:bg-pink-700 text-white font-bold text-sm rounded transition-colors cursor-pointer flex items-center justify-center gap-2 mt-2 shadow-sm"
 >
