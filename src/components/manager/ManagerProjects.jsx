...
export default function ManagerProjects() {
 ...
 <td className="p-4 text-sm font-medium text-slate-900">{p.title}</td>
 ...
 <td className="p-4 text-sm text-slate-600">
 <span className="px-3 py-1 rounded text-xs font-medium bg-slate-100">{p.status}</span>
 </td>
 ...
 <input value={formData.technologyStack} onChange={e => setFormData({...formData, technologyStack: e.target.value})} className="w-full p-2 border rounded" />
 </div>
 <div>
 ...
 <select value={formData.developer} onChange={e => setFormData({...formData, developer: e.target.value})} className="w-full p-2 border rounded">
