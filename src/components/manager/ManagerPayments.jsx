...
export default function ManagerPayments() {
 ...
 <td className="p-4 text-sm font-medium text-slate-900">{p.projectTitle ||"N/A"}</td>
 <td className="p-4 text-sm text-slate-600">{p.student?.fullName ||"Unassigned"}</td>
 <td className="p-4 text-sm text-slate-900 font-bold">{p.currency} {p.amount}</td>
 ...
 (p.status ==="paid" || p.status ==="completed") ?"bg-green-100 text-green-700" : 
 (p.status ==="closing" || p.status ==="failed") ?"bg-red-100 text-red-700" :
 ...
 <select required value={formData.student} onChange={e => setFormData({...formData, student: e.target.value})} className="w-full p-2 border rounded">
 ...
 <input type="number" required value={formData.amount} onChange={e => setFormData({...formData, amount: Number(e.target.value)})} className="w-full p-2 border rounded" />
 </div>
 <div>
 <label className="block text-sm font-medium mb-1">Currency</label>
 <select value={formData.currency} onChange={e => setFormData({...formData, currency: e.target.value})} className="w-full p-2 border rounded">
 ...
 <input value={formData.transactionId} onChange={e => setFormData({...formData, transactionId: e.target.value})} className="w-full p-2 border rounded" />
 </div>
 </div>
 <div>
