...
const categoryColors = {"Success Story":"bg-emerald-100 text-emerald-800","Project Showcase":"bg-blue-100 text-blue-800","Workshop":"bg-purple-100 text-purple-800","Announcement":"bg-amber-100 text-amber-800","Tips & Tricks":"bg-teal-100 text-teal-800","Other":"bg-slate-100 text-slate-800",
};
...
function StoryCard({ story, onClick }) {
 ...
 className="bg-white border border-slate-200 rounded-md overflow-hidden shadow-sm hover:shadow-md transition-shadow hover:shadow-md transition-shadow hover:shadow-sm hover:shadow-md transition-shadow hover:shadow-md transition-shadow hover:-translate-y-1 transition-all cursor-pointer group"
 ...
 <h3 className="text-sm font-black text-slate-950 group-hover:text-blue-600 transition-colors">
 {story.title}
 </h3>
...
function StoryDetail({ storyId, onBack }) {
 ...
 <button
 onClick={onBack}
 className="flex items-center gap-2 text-sm font-bold text-slate-600 hover:text-slate-950 mb-6 cursor-pointer transition-colors"
 id="story-back-btn"
 >
 ...
 <div className="rounded-md overflow-hidden border border-slate-200 shadow-sm hover:shadow-md transition-shadow hover:shadow-md transition-shadow mb-8">
 <img
 ...
 <span className={`text-[10px] font-black uppercase px-2.5 py-1 rounded-lg border border-slate-200 ${categoryColors[story.category] || categoryColors["Other"]}`}>
 {story.category}
 </span>
 ...
 <h1 className="text-2xl sm:text-3xl font-black text-slate-950 mb-6 leading-tight">
 {story.title}
 </h1>
 ...
 {story.tags.map((tag) => (
 <span key={tag} className="text-[10px] font-bold px-2.5 py-1 bg-slate-100 text-slate-600 rounded-lg border border-slate-200">
 #{tag}
 </span>
 ))}
 </div>
...
export default function StoriesView() {
 ...
 <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-100 text-blue-700 rounded text-xs font-black uppercase tracking-widest border border-blue-200 mb-4">
 <BookOpen className="w-3.5 h-3.5" />
 Stories & Insights
 </div>
 <h1 className="text-3xl sm:text-4xl font-black text-slate-950 mb-3 tracking-tight">
 ...
 className="w-full pl-10 pr-4 py-3 bg-white border-2 border-slate-200 rounded text-sm text-slate-800 focus:outline-none focus:border-blue-500 font-medium"
 id="stories-search"
 />
 </div>
 ...
 className={`px-3.5 py-2.5 text-xs font-black rounded border-2 transition-all cursor-pointer ${
 category === cat
 ?"bg-blue-600 text-white border-blue-600 shadow-sm hover:shadow-md transition-shadow hover:shadow-md transition-shadow"
 ...
 <div className="w-20 h-20 bg-slate-100 rounded-md border-2 border-slate-200 flex items-center justify-center mx-auto mb-4">
 <BookOpen className="w-10 h-10 text-slate-400" />
 </div>
 <h3 className="text-lg font-black text-slate-700 mb-2">No Stories Yet</h3>
 ...
 className="px-4 py-2 text-xs font-bold bg-white border-2 border-slate-200 rounded disabled:opacity-40 hover:border-blue-500 transition-colors cursor-pointer"
 >
 ← Prev
 </button>
