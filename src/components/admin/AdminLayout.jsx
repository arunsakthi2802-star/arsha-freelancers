...
export default function AdminLayout({ activeTab, setActiveTab, onNavigatePublic, children }) {
 ...
 <div className="flex items-center gap-3">
 <div className="w-9 h-9 bg-blue-600 rounded flex items-center justify-center text-white text-xs font-black border border-slate-700">
 ...
 className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded text-xs font-bold transition-all cursor-pointer ${
 activeTab === id
 ...
 className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded text-xs font-bold text-slate-400 hover:text-white hover:bg-slate-800 transition-all cursor-pointer"
 ...
 className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded text-xs font-bold text-red-400 hover:text-white hover:bg-red-600 transition-all cursor-pointer"
 id="admin-logout-btn"
 >
 ...
 {/* Top bar */}
 <div className="flex items-center gap-3 px-4 py-3 bg-white border-b-2 border-slate-200 flex-shrink-0">
 <button
 onClick={() => setSidebarOpen(true)}
 className="lg:hidden p-2 text-slate-500 hover:text-slate-950 cursor-pointer"
 aria-label="Open sidebar"
 >
 <Menu className="w-5 h-5" />
 </button>
 <div>
 <h2 className="text-sm font-black text-slate-950 capitalize">
