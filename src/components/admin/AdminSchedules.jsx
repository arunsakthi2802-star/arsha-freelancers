...
export default function AdminSchedules() {
 ...
 <h2 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Schedules</h2>
 ...
 className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-bold transition-all shadow-sm hover:shadow-md transition-shadow hover:shadow-md transition-shadow active:translate-x-[4px] active:translate-y-[4px] active:shadow-none"
 >
 ...
 <h3 className="text-xl font-bold mb-4 text-slate-900">Create New Schedule</h3>
 ...
 className="w-full p-2 border-2 border-slate-200 rounded-lg bg-slate-50 focus:outline-none focus:border-blue-500"
 >
 ...
 type="submit" 
 disabled={addLoading}
 className="w-full bg-slate-900 text-white font-bold py-3 rounded hover:bg-slate-800 transition-colors mt-4 disabled:opacity-70"
 >
 ...
 <th className="p-4 text-sm font-bold text-slate-600">Title & Type</th>
 <th className="p-4 text-sm font-bold text-slate-600">Date & Time</th>
 ...
 <tr key={schedule._id} className="border-b border-slate-100 last:border-0 hover:bg-slate-50">
 <td className="p-4">
 <div className="flex items-center gap-2">
 <UserIcon className="w-4 h-4 text-slate-400" />
 <div>
 <p className="font-bold text-sm text-slate-900">{schedule.user?.fullName ||"Unknown User"}</p>
 <p className="text-xs text-slate-500">{schedule.user?.email}</p>
 </div>
 </div>
 </td>
 <td className="p-4">
 <p className="font-bold text-sm text-slate-900">{schedule.title}</p>
 <span className="inline-block px-2 py-0.5 bg-blue-100 text-blue-700 text-[10px] rounded uppercase font-bold mt-1">
 {schedule.type}
 </span>
 </td>
 <td className="p-4">
 ...
 schedule.status ==="cancelled" ?"bg-red-100 border-red-200 text-red-700" :"bg-orange-100 border-orange-200 text-orange-700"
 }`}
 >
