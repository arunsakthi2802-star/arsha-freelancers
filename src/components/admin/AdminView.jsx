...
export default function AdminView({ onNavigate }) {
 ...
 <p className="text-sm text-slate-500 mb-6">Your account does not have administrator or manager privileges.</p>
 <button
 onClick={() => onNavigate("home")}
 className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-black text-sm rounded border border-slate-200 shadow-sm hover:shadow-md transition-shadow hover:shadow-md transition-shadow cursor-pointer"
 >
 Go to Home
 </button>
 </div>
