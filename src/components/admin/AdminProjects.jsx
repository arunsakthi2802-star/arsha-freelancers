...
export default function AdminProjects() {
 ...
 <div>
 <h2 className="text-lg font-black text-slate-950">Projects Management</h2>
 <p className="text-xs text-slate-400">{filteredProjects.length} total projects</p>
 </div>
 <div className="flex gap-2">
 <button onClick={openCreateModal} className="flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-black rounded border border-slate-200 shadow-sm hover:shadow-md transition-shadow hover:shadow-md transition-shadow cursor-pointer">
 ...
 className="w-full pl-9 pr-3 py-2.5 bg-white border-2 border-slate-200 rounded text-xs text-slate-800 focus:outline-none focus:border-blue-500" 
 />
 </div>

 <div className="bg-white border border-slate-200 rounded-md overflow-hidden shadow-sm hover:shadow-md transition-shadow hover:shadow-md transition-shadow flex-1 overflow-y-auto">
 {loading ? (
 ...
 <td className="px-4 py-3">
 <span className="px-2 py-1 rounded bg-blue-100 text-blue-700 font-bold text-[10px]">{p.status}</span>
 </td>
 <td className="px-4 py-3">
 <div className="w-full bg-slate-200 rounded h-1.5 max-w-[80px]">
 <div className="bg-emerald-500 h-1.5 rounded" style={{ width: `${p.completionPercentage || 0}%` }}></div>
 </div>
 ...
 <div className="bg-white border border-slate-200 rounded-md p-6 w-full max-w-lg shadow-sm hover:shadow-md transition-shadow hover:shadow-md transition-shadow my-8">
 <div className="flex items-center justify-between mb-4">
 <h3 className="text-sm font-black text-slate-950">{isEditing ?"Edit Project Details" :"Create New Project"}</h3>
 ...
 <button type="submit" disabled={saving} className="px-4 py-2.5 bg-blue-600 text-white text-xs font-black rounded border border-slate-200 cursor-pointer disabled:opacity-50 flex items-center gap-1.5">
 {saving ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Check className="w-3.5 h-3.5" />} Save Project
 </button>
 <button type="button" onClick={() => setProjectModal(null)} className="px-4 py-2.5 bg-slate-100 text-slate-600 text-xs font-black rounded border-2 border-slate-200 cursor-pointer">Cancel</button>
 </div>
 </form>
 </div>
 </div>
 ...
 <p className="text-xs text-slate-400 mb-4">Client: <span className="font-bold text-slate-600">{resourceModal.student?.fullName ||"Unknown"}</span></p>
 ...
 disabled
 className="w-full px-3 py-2 bg-slate-100 border border-slate-200 rounded text-xs text-slate-800 focus:outline-none cursor-not-allowed"
 />
 </div>
 <div className="space-y-1">
