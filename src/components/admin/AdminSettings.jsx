...
export default function AdminSettings() {
 ...
 <div>
 <h2 className="text-lg font-black text-slate-950">Admin Account Settings</h2>
 <p className="text-xs text-slate-400">Change your login username (email) and password.</p>
 </div>

 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 {/* Profile Card */}
 <div className="bg-white border border-slate-200 rounded-md p-5 shadow-sm hover:shadow-md transition-shadow hover:shadow-md transition-shadow space-y-4">
 ...
 className="w-full pl-9 pr-3 py-2 bg-slate-50 border border-slate-200 rounded text-xs text-slate-800 focus:outline-none"
 required
 />
 </div>
 </div>
 ...
 className="px-4 py-2 bg-blue-600 text-white text-xs font-black rounded border border-slate-200 cursor-pointer disabled:opacity-50 flex items-center gap-1.5"
 >
 ...
 className="px-4 py-2 bg-purple-600 text-white text-xs font-black rounded border border-slate-200 cursor-pointer disabled:opacity-50 flex items-center gap-1.5"
 >
