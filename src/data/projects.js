const baseProjects = [
 ...
 description:"An automated screening system using NLP and Machine Learning to parse, extract, and grade resumes against healthcare job descriptions.",
 technology: ["Python","NLTK","Flask","React","Tailwind CSS"],
 category:"Artificial Intelligence",
 difficulty:"Advanced",
 duration:"4 Weeks",
 features: ["PDF text extraction","NLP skill matching","Ranking algorithm","Dashboard analytics",
 ],
 department:"MCA",
 },
 {
 ...
 description:"Real-time attendance management system using OpenCV facial embedding models, auto-generating Excel sheets and sending SMS alerts to parents.",
 technology: ["Python","OpenCV","TensorFlow","SQLite","Tkinter"],
 category:"Machine Learning",
 difficulty:"Intermediate",
 duration:"3 Weeks",
 features: ["Real-time camera detection","Face registration","Automatic CSV reports","Parent SMS trigger",
 ],
 department:"CS",
 },
 {
 ...
 description:"A secure, transparent Web3 portal where creators launch campaigns and backers fund them via smart contracts with multi-signature milestones.",
 technology: ["Solidity","React","Ethers.js","Hardhat","Metamask"],
 category:"Blockchain",
 difficulty:"Advanced",
 duration:"6 Weeks",
 features: ["Smart contract funds release","Milestone voting","Low gas optimization","NFT donor rewards",
 ],
 department:"IT",
 },
 {
 ...
 description:"An IoT-coupled agricultural prediction tool analyzing moisture, NPK values, and climate forecasts to suggest ideal seed and fertilizer types.",
 technology: ["Python","Scikit-Learn","IoT Sensors","Flask","Chart.js"],
 category:"Data Science",
 difficulty:"Intermediate",
 duration:"4 Weeks",
 features: ["Real-time NPK readings","Crop recommendations","Price forecasting","Fertilizer dosage recommendations",
 ],
 department:"BCA",
 },
 {
 ...
 description:"A high-fidelity log analysis dashboard monitoring network packets, flagging intrusion signatures (DDoS, Brute force), and raising instant triggers.",
 technology: ["Python","Scapy","React","Node.js","Socket.io"],
 category:"Cybersecurity",
 difficulty:"Advanced",
 duration:"5 Weeks",
 features: ["PCAP packet inspection","IP Geolocation lookup","Visual alert sirens","Slack integration alerts",
 ],
 department:"IT",
 },
 {
 ...
 description:"A comprehensive MERN stack application designed for doctor scheduling, digital prescription storage, billing, and queue management.",
 technology: ["MongoDB","Express.js","React","Node.js","Tailwind CSS"],
 category:"MERN Stack",
 difficulty:"Intermediate",
 duration:"3 Weeks",
 features: ["Appointment booking engine","Virtual prescriptions","PDF billing receipts","Interactive floor maps",
 ],
 department:"MCA",
 },
 {
 ...
 description:"A simulation of traffic lights that dynamically adjust green light timers based on vehicle density calculated from infrared sensor counts.",
 technology: ["Arduino","Raspberry Pi","Python","MQTT Broker","Tkinter"],
 category:"IoT",
 difficulty:"Intermediate",
 duration:"4 Weeks",
 features: ["Density calculation","Emergency vehicle overrides","Central monitoring server","Solar backup control logic",
 ],
 department:"ECE",
 },
 {
 ...
 description:"A web browser extension leveraging heuristic models and machine learning to scan page DOMs and URLs for phishing attributes.",
 technology: ["JavaScript","Python","Flask","TensorFlow.js","Chrome API",
 ],
 category:"Cybersecurity",
 difficulty:"Advanced",
 duration:"4 Weeks",
 features: ["Real-time URL checking","Social engineering heuristics","Popup warning blockers","User reporting portal",
 ],
 department:"CS",
 },
 {
 ...
 description:"A secure cloud storage platform with hybrid cryptography (AES & RSA), encrypting files client-side before uploading to cloud space.",
 technology: ["React","Node.js","AWS S3","Web Crypto API","MongoDB"],
 category:"Cloud Computing",
 difficulty:"Advanced",
 duration:"5 Weeks",
 features: ["Client-side RSA key generation","Encrypted file streaming","Dynamic link sharing","Automated file shredding",
 ],
 department:"IT",
 },
 {
 ...
 description:"A mobile Flutter app paired with an in-cab camera to detect facial fatigue patterns in logistics drivers, sounding alarms and reporting logs.",
 technology: ["Flutter","Dart","Firebase","Python (Fatigue Detection)","OpenCV",
 ],
 category:"Android",
 difficulty:"Advanced",
 duration:"5 Weeks",
 features: ["Yawning & eye blink ratio check","Offline tracking capabilities","Alert sirens for driver","Manager panel telemetry",
 ],
 department:"MCA",
 },
 {
 ...
 description:"A virtual classroom platform featuring interactive assignment tracking, automated grading for quizzes, and forum discussions.",
 technology: ["React","Node.js","Express.js","PostgreSQL","Socket.io"],
 category:"Full Stack",
 difficulty:"Intermediate",
 duration:"3 Weeks",
 features: ["Automatic quiz evaluation","Real-time whiteboard","Attendance logger","Progress visual charts",
 ],
 department:"BCA",
 },
 {
 ...
 description:"Sniffs network cards, analyzes metrics with random forest classification, and flags anomalies or malicious port scan behavior.",
 technology: ["Python","Scipy","Scikit-Learn","MySQL","React Dashboard"],
 category:"Networking",
 difficulty:"Advanced",
 duration:"5 Weeks",
 features: ["Live network sniffer","Machine learning packet evaluation","Intruder IP isolation","Log history archive",
 ],
 department:"CS",
 },
 {
 ...
 description:"A hardware-software platform logging energy spikes and patterns across household devices, recommending power-saving scheduling.",
 technology: ["Raspberry Pi","React Native","Firebase","Python","MQTT"],
 category:"IoT",
 difficulty:"Advanced",
 duration:"4 Weeks",
 features: ["Appliance energy log","Abnormal load trip switch","Weekly consumption predictions","Cost estimates in local currency",
 ],
 department:"EEE",
 },
 {
 ...
 description:"An assistive application converting audio speech to instant sign language illustrations and hand gestures, or camera-read signs to text.",
 technology: ["Python","MediaPipe","OpenCV","Flutter","Web Speech API"],
 category:"Python",
 difficulty:"Intermediate",
 duration:"4 Weeks",
 features: ["Real-time visual playback","Customizable sign avatar","Voice commands parsing","Educational quiz module",
 ],
 department:"CS",
 },
 {
 ...
 description:"An intelligent platform for matching resumes against competitive positions, providing automated rewrite instructions for high ATS scoring.",
 technology: ["Python","NLP","Flask","React","Tailwind CSS"],
 category:"Python",
 difficulty:"Beginner",
 duration:"2 Weeks",
 features: ["Keyword denseness analyzer","ATS standard formatter","One-click layout download","Skill gap feedback",
 ],
 department:"BCA",
 },
 {
 ...
 description:"Verifies the pixel-level integrity of surveillance captures and stores tamper-evident cryptographic hashes across a secure database.",
 technology: ["Java","SHA-256","Spring Boot","PostgreSQL","React"],
 category:"Java",
 difficulty:"Intermediate",
 duration:"3 Weeks",
 features: ["Metadata extraction & checking","Batch file hashing","Security log ledger","Integrity warning badge",
 ],
 department:"CS",
 },
 {
 ...
 description:"An interactive dashboard enabling managers to upload sales files and view high-probability churn alerts with actionable target campaigns.",
 technology: ["Python","Pandas","Streamlit","XGBoost","React"],
 category:"Data Science",
 difficulty:"Intermediate",
 duration:"3 Weeks",
 features: ["CSV/Excel mass parsing","Churn probability score","Promotional message compiler","Customer cluster segments",
 ],
 department:"MBA",
 },
];
...
export const departmentSuggestions = {
 CS: ["Smart Attendance System using Facial Recognition","Phishing Attack Detection & Guard Extension","Network Intrusion Detection System (NIDS)","Voice-Controlled Interactive Sign Language Aid","Digital Forensics Image Log Integrity Checker",
 ],
 IT: ["Decentralized Crowdfunding Platform on Ethereum","Cyber Threat Detection & SIEM Dashboard","Secure Cloud-Based File Storage with Dynamic Keys",
 ],
 MCA: ["AI-Powered Medical Resume Screening & Parser","Automated Hospital Management & Patient Portal","E-Commerce Logistics & Driver Fatigue Monitor",
 ],
 BCA: ["Predictive Crop Yield & Soil Health Management","Student Learning Management System (LMS)","Automated Resume Matcher & ATS Optimizer",
 ],
 ECE: ["IoT-Based Intelligent Traffic Flow Controller","Smart Home Energy Grid Monitor",
 ],
 EEE: ["Smart Home Energy Grid Monitor"],
 MBA: ["Predictive Analytics for Retail Customer Churn","Resume Matcher & ATS Optimizer",
 ],
};

// --- 5000 GENERATED PROJECTS ---
const TECH_PREFIXES = ["AI-Powered","IoT-Based","Blockchain-Enabled","Smart","Cloud-Based","Decentralized","Automated","Predictive","Real-Time","Mobile-First","Data-Driven","Web3","Machine Learning","Serverless","Edge-Computing","AR/VR","5G-Enabled","Autonomous","Vision-Based","Voice-Controlled","Cross-Platform","Open-Source","Next-Gen","Scalable","Distributed"
 ];
const FUNCTIONS = ["Monitoring System","Tracking Platform","Management Tool","Detection Engine","Analysis Dashboard","Optimization Application","Recommendation System","Reporting Portal","Automation Network","Forecasting Model","Analytics Hub","Decision Support System","Virtual Assistant","Resource Allocator","Feedback Loop","Control Interface","Diagnostic Tool","Alert Mechanism","Verification Ledger","Collaboration Workspace"
 ];
const SUBJECTS = {"Healthcare & Telemedicine": ["Patient Care","Disease Outbreak","Clinical Resource","Medicine Supply","Tele-consultation","Vitals","Mental Wellbeing","Vaccine Distribution","Maternal Health","Medical Record"],"Agriculture & Food Security": ["Crop Yield","Soil Health","Weather Pattern","Livestock","Fertilizer Usage","Irrigation","Farm Machinery","Seed Distribution","Commodity Price","Harvest Storage"],"Education & Skill Development": ["Student Performance","E-Learning","Exam Grading","Skill Development","Curriculum","Attendance","Career Counseling","Special Education","Library Resources","Campus Safety"],"Environment & Sustainability": ["Air Quality","Water Pollution","Deforestation","Waste Recycling","Carbon Emission","Energy Consumption","Wildlife Conservation","Noise Level","Renewable Energy","Climate Change"],"Disaster Management & Safety": ["Flood Alert","Earthquake Rescue","Evacuation Route","Relief Material","Cyclone Warning","Structural Health","Fire Emergency","Volunteer Dispatch","Hazard Risk","Crisis Communication"],"Smart City & E-Governance": ["Traffic Flow","Street Lighting","Waste Collection","Public Transit","Parking Space","Civic Grievance","Water Supply","Energy Grid","Public Space Safety","Municipal Infrastructure"],"Accessibility & Inclusion": ["Visual Impairment","Hearing Aid","Mobility Assistance","Sign Language","Speech Therapy","Cognitive Support","Wheelchair Routing","Braille Learning","Autism Care","Accessible Transit"],"Financial Inclusion & Livelihood": ["Micro-Loan","Remittance","Expense Tracking","Financial Literacy","Credit Scoring","Chit-Fund","Insurance Claim","Gig Worker Payout","Street Vendor Sales","Rural Banking"],"Transportation & Logistics": ["Fleet Route","Public Bus","Cargo Delivery","Road Condition","Electric Vehicle","Traffic Accident","Driver Fatigue","Logistics","Toll Collection","Commuter Ride"],"Data Security & Privacy": ["Data Privacy","Cyber Threat","Identity Fraud","Phishing Attack","Network Intrusion","Access Control","Ransomware","Secure Messaging","Endpoint Security","System Vulnerability"]
 };
const META = {"Healthcare & Telemedicine": {
...
export const studentProjects = [...baseProjects, ...generatedProjects].map((project, idx) => {
 ...
 const securityFeatures = ["Role-based Access Control (RBAC)","End-to-End Encryption (AES-256)","JWT Authentication Tokens","SQL Injection & XSS Protection"
 ];
 const deploymentPlan = ["Phase 1: Local Environment Setup & DB Modeling","Phase 2: Core API & Frontend Integration","Phase 3: Testing & Quality Assurance","Phase 4: Cloud Deployment"
 ];
 const futureScope = ["Integration with Mobile Applications","AI/ML Predictive Analytics module","Blockchain for immutable audit logs"
 ];
 const learningOutcomes = ["Mastery in full-stack architecture design",
 `Hands-on experience with ${project.technology[0] || 'modern frameworks'} and ${project.technology[1] || 'databases'}`,"Understanding of modern deployment workflows","Implementation of industry-standard security practices"
 ];
