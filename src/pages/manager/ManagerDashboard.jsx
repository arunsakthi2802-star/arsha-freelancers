...
export default function ManagerDashboard({ onNavigate }) {
 ...
 <p className="text-sm text-slate-500 mb-6">Your account does not have manager privileges.</p>
 <button
 ...
 */
 ...
 {/* Sidebar */}
 <div className="w-full md:w-64 bg-slate-900 border-r border-slate-800 p-6 flex flex-col text-white">
 <div className="mb-10">
