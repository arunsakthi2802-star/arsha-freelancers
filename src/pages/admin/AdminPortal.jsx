...
export default function AdminPortal({ onNavigate }) {
 ...
 <div className="w-16 h-16 bg-red-100 text-red-600 rounded-md flex items-center justify-center mx-auto mb-4 border-2 border-red-200">
 🔒
 </div>
 <h2 className="text-xl font-black text-slate-950 mb-2">Access Denied</h2>
 <p className="text-sm text-slate-500 mb-6">Your account does not have administrator privileges.</p>
 <button
 onClick={() => onNavigate("home")}
 className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-black text-sm rounded cursor-pointer"
 >
 Go to Home
 </button>
 </div>
 ...
 */
 ...
 <button 
 onClick={() => onNavigate("home")}
 className="w-full flex items-center gap-3 px-4 py-3 rounded font-medium text-slate-400 hover:bg-slate-800 hover:text-white transition-colors"
 >
 ...
 className="w-full flex items-center gap-3 px-4 py-3 rounded font-medium text-red-400 hover:bg-red-500/10 transition-colors"
 >
 ...
 <h2 className="text-2xl font-bold text-slate-900 mb-6">Website Content Management</h2>
